...
Вы также можете добавить запись `medium.i2p,f26brxp77ydqc7cnjctnj75ktcgjhh3tqqvrgf4a6l25aqk3vp3a` в адресную книгу своего I2P маршрутизатора, чтобы ваши клиенты могли проверить возможность подключения к сети I2P путём посещения сайта [medium.i2p](http://medium.i2p).
